...
ALTER TABLE gameyear
    ADD CONSTRAINT gameyear_pk PRIMARY KEY ( platform,
                                             game_name,
                                             publisher );
...
ALTER TABLE gameyear
    ADD CONSTRAINT gameyear_gameplatform_fk FOREIGN KEY ( platform,
                                                          game_name,
                                                          publisher )
        REFERENCES gameplatformpublisher ( platform,
                                           game_name,
